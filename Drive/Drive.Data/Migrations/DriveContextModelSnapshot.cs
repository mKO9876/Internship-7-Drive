...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Drive.Data.Entities.Models.Comments", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CommentingDate = new DateTime(2023, 1, 12, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            FileId = 1,
                            UserId = 1
                        },
                        new
                        {
                            ...
                            CommentingDate = new DateTime(2023, 2, 18, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            FileId = 2,
                            UserId = 2
                        },
                        new
                        {
                            ...
                            CommentingDate = new DateTime(2023, 3, 22, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            FileId = 3,
                            UserId = 1
                        },
                        new
                        {
                            ...
                            CommentingDate = new DateTime(2023, 4, 5, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            FileId = 4,
                            UserId = 3
                        },
                        new
                        {
                            ...
                            CommentingDate = new DateTime(2023, 5, 14, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            FileId = 5,
                            UserId = 2
                        },
                        new
                        {
                            ...
                            CommentingDate = new DateTime(2023, 6, 7, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            FileId = 6,
                            UserId = 4
                        },
                        new
                        {
                            ...
                            CommentingDate = new DateTime(2023, 7, 29, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            FileId = 7,
                            UserId = 3
                        },
                        new
                        {
                            ...
                            CommentingDate = new DateTime(2023, 8, 21, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            FileId = 8,
                            UserId = 4
                        });
                });

            modelBuilder.Entity("Drive.Data.Entities.Models.Directories", b =>
                {
            ...
            modelBuilder.Entity("Drive.Data.Entities.Models.DirectoriesFiles", b =>
                {
                    b.Property<int>("DirectoryId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Drive.Data.Entities.Models.Files", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            FileId = 1,
                            FileName = "Resume.pdf",
                            LastChanged = new DateTime(2023, 1, 10, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            FileId = 2,
                            FileName = "VacationPhoto.jpg",
                            LastChanged = new DateTime(2023, 2, 15, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            FileId = 3,
                            FileName = "ProjectPlan.docx",
                            LastChanged = new DateTime(2023, 3, 5, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            FileId = 4,
                            FileName = "MusicTrack.mp3",
                            LastChanged = new DateTime(2023, 4, 20, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            FileId = 5,
                            FileName = "VideoClip.mp4",
                            LastChanged = new DateTime(2023, 5, 25, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            FileId = 6,
                            FileName = "Presentation.pptx",
                            LastChanged = new DateTime(2023, 6, 30, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            FileId = 7,
                            FileName = "Backup.zip",
                            LastChanged = new DateTime(2023, 7, 10, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            FileId = 8,
                            FileName = "Archive.tar.gz",
                            LastChanged = new DateTime(2023, 8, 15, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        });
                });

            modelBuilder.Entity("Drive.Data.Entities.Models.Users", b =>
                {
                    b.Property<int>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Drive.Data.Entities.Models.UsersFiles", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Drive.Data.Entities.Models.Comments", b =>
                {
                    b.HasOne("Drive.Data.Entities.Models.Users", "User")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("Drive.Data.Entities.Models.DirectoriesFiles", b =>
                {
                    b.HasOne("Drive.Data.Entities.Models.Directories", "Directory")
                        .WithMany("DirectoriesFiles")
                        .HasForeignKey("DirectoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Drive.Data.Entities.Models.Files", "File")
                        .WithMany("DirectoriesFiles")
